            ...
            Container(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    TextFieldWidget(
                        'الاسم', Icons.person_outlined, nameController,(String? input){
                    ...
                    TextFieldWidget(
                        'عنوان المنزل', Icons.home_outlined, homeController,(String? input){

                          if(input!.isEmpty){
                            return 'عنوان المنزل مطلوب!';
                          }
                    ...
                    TextFieldWidget('عنوان العمل', Icons.card_travel,
                        businessController,(String? input){
                          if(input!.isEmpty){
                            return 'عنوان العمل مطلوب!';
                          }
                    ...
                    Obx(() => authController.isProfileUploading.value
                        ...
                        : greenButton('إرسال', () {
                            ...
                            if (selectedImage == null) {
                              Get.snackbar('تنبيه', 'الرجاء إضافة الصورة الخاصة بك');
                              return;
                            }
