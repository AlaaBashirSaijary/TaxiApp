  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text('تحميل الوثائق',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600,color: Colors.black),),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text('استمارة المركبة',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: Colors.black),),
                  Text('في إنتظار القبول',style: TextStyle(fontSize: 12,color: Color(0xff62B62F)),),
