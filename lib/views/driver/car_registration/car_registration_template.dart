...
import 'package:taxiapp/views/driver/car_registration/pages/document_uploaded_page.dart';
import 'package:taxiapp/views/driver/car_registration/pages/location_page.dart';
import 'package:taxiapp/views/driver/car_registration/pages/upload_document_page.dart';
import 'package:taxiapp/views/driver/car_registration/pages/vehical_color_page.dart';
import 'package:taxiapp/views/driver/car_registration/pages/vehical_make.dart';
import 'package:taxiapp/views/driver/car_registration/pages/vehical_model_page.dart';
import 'package:taxiapp/views/driver/car_registration/pages/vehical_model_year_page.dart';
import 'package:taxiapp/views/driver/car_registration/pages/vehical_number_page.dart';
      ...
      child: Scaffold(
        body: Column(
          ...
          children: [
            ...
            greenIntroWidgetWithoutLogos(title: 'تسجيل السيارة',subtitle: 'إكمال تفاصيل العملية'),
            ...
            Align(
                ...
                child: Padding(
                  ...
                  },child: Icon(Icons.arrow_forward_ios_outlined,color: Colors.white,),backgroundColor: AppColors.greenColor,)),
                )),
